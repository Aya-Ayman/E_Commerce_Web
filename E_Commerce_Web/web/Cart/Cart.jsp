...
<html>
    ...
    <body>
        ...
        <div class="modal-body modal-body-sub_agile">
            ...
            <c:forEach items="${QuantityErrorList}" var="ailment">
                <c:if test="${ErrorMsgLenght > '0'}">
              <span  style="display: block"  id="display-error"><img src="images/error.png" alt="Error" /> ${ailment}</span>
              </c:if>
            </c:forEach>
               <c:if test="${CreditState > '0'}">
                 <span style="display: block"  id="display-error"><img src="images/error.png" alt="Error" />${CreditState}</span>              
                </c:if>             
