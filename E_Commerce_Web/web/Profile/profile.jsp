        ...
        <div class="modal-body modal-body-sub_agile">
            ...
            <form action="RedirectEditProfile"  method="post" >
                ...
                <div>
                    ...
                    <label class="labell" >Email</label><br/><br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${User.email}
                ...
                <div>
                    ...
                    <label class="labell" >Birth Date</label><br/><br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${User.date}
                ...
                <div >
                    ...
                    <label class="labell">Address</label><br/><br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${User.address}
                </div>
                ...
                <div>
                    ...
                    <br/>
                    <label class="labell">Job</label><br/><br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${User.job}
                    <span></span>
                </div>
                ...
                <div> 
                    ...
                    <br/> 
                    <label class="labell">Credit Limit</label><br/><br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${User.credit_limit}
                </div>
