        ...
        <div class="modal-body modal-body-sub_agile">
            ...
            <form action="EditProfile"  method="post"  enctype="multipart/form-data" onsubmit="return validForm();">
                ...
                <div>
                    ...
                    <div>
                        <div><label class="labell">Name</label></div><br>
                    <input class="field" type="Text" name="name" id="editname" value="${User.first_name}" onChange="validName()">
                ...
                <div>
                    ...
                    <div><label class="labell">Email</label></div><br>
                    <input class="field" type="Text" name="email" id="editemail" value="${User.email}" readonly> 
                    <br>
                ...
                <div>
                    ...
                    <div><label class="labell">Password</label><div><br>
                    <input class="field" type="Text" name="password" id="editpassword" value="${User.password}"> 
                ...
                <div>
                    ...
                    <div><label class="labell">Date</label></div><br>
                    <input class="field" type="Text" name="date" id="editdate" value="${User.date}" onChange="validDate()"> 
                ...
                <div >
                    ...
                    <div><label class="labell">address</label></div><br>
                    <input class="field" type="Text" name="address" id="editaddress" value="${User.address}"> 
                ...
                <div>
                    ...
                    <div><label class="labell">job</label></div><br>
                    <input class="field" type="Text" name="job" id="editjob" value="${User.job}" onChange="validJob()"> 
                    ...
                    <div><label class="labell">Add your PromoCode</label><div><br>
                            <input class="field" type="Text" name="promo" id="editcredit" value=""  > 
                ...
                <div>
                    <label class="labell">Interests</label>
                    <br/><br/>
                    <input style="margin-left: 30px" type="checkbox" name="interest" value="Casual wear">Casual wear<br>
                    <input style="margin-left: 30px" type="checkbox" name="interest" value="Electronics">Electronics<br>
                    <input style="margin-left: 30px" type="checkbox" name="interest" value="Shoes">Shoes<br>
                    <input style="margin-left: 30px" type="checkbox" name="interest" value="Sports">Sports<br>
                </div>
                ...
                <br/><br/>
                    ...
                    <div><label style="display:none;">credit</label><div>
                    <input type="Text" name="credit" id="editcredit" value="${User.credit_limit}"  style="display:none;" > 
