...
({1: [function (a, b, c) {
        ...
        }, {}], 2: [function () {}, {}], 3: [function (a, b, c)
        {
                    ...
                    }, c.relative = function (a, b)
            {
                ...
                for (var e = d(a.split("/")), f = d(b.split("/")),
        ...
        {__browserify_process: 5, _shims: 1, util: 4}], 4: [function (a, b, c)
        {
            ...
            function h(a, b, d) {
                if (a.customInspect && b && z(b.inspect) && b.inspect !== c.inspect &&
                ...
                if (v(b) && (r = " " + RegExp.prototype.toString.call(b)),
                        ...
                        y(b) && (r = " " + j(b)), 0 === o.length && (!t || 0 == b.length))
                    return u[0] + r + u[1];
                if (0 > d)
                    return v(b) ? a.stylize(RegExp.prototype.toString.call(b), "regexp")
            ...
            function i(a, b) {
                ...
                return r(b) ? a.stylize("" + b, "number") : o(b) ? a.stylize("" + b, "boolean") :
                        p(b) ? a.stylize("null", "null") : void 0
            }
            function j(a) {
            ...
            {
                var g, i, j;
                if (j = G.getOwnPropertyDescriptor(b, e) || {value: b[e]},
                        j.get ? i = j.set ? a.stylize("[Getter/Setter]", "special")
                        : a.stylize("[Getter]", "special")
                        : j.set && (i = a.stylize("[Setter]", "special"))
                        , F(d, e) || (g = "[" + e + "]"), i || (G.indexOf(a.seen, j.value) < 0 ? (i = p(c) ? h(a, j.value, null)
            ...
            function A(a)
            {
                return null === a || "boolean" == typeof
                        a || "number" == typeof a || "string" == typeof a || "symbol" == typeof
                        a || "undefined" == typeof a
            }
            function B(a) {
                return a && "object" == typeof
                        a && "function" == typeof a.copy && "function" == typeof a.fill && "function" == typeof
                        a.binarySlice
            }
            function C(a) {
            ...
            c.format = function (a)
            {
                ...
                for (var c = 1, e = arguments, f = e.length, g = String(a)
            ...
            , c.inspect = d, d.colors =
                    {bold: [1, 22], italic: [3, 23],
                        ...
                        yellow: [33, 39]}, d.styles = {
                special: "cyan", number: "yellow", "boolean": "yellow",
                undefined: "grey", "null": "bold", string: "green", date: "magenta",
                regexp: "red"},
                    c.isArray = n, c.isBoolean = o, c.isNull = p, c.isNullOrUndefined = q,
                    c.isNumber = r, c.isString = s, c.isSymbol = t, c.isUndefined = u,
                    c.isRegExp = v, c.isObject = w, c.isDate = x, c.isError = y, c.isFunction = z,
                    c.isPrimitive = A, c.isBuffer = B;
        ...
        }, {_shims: 1}], 5: [function (a, b)
        {
            ...
            c.nextTick = function ()
            {
                ...
                if (b) {
                    ...
                    return window.addEventListener("message", function (a)
                    {
                        var b = a.source;
                        if ((b === window || null === b)
                                && "process-tick" === a.data && (a.stopPropagation(), c.length > 0))
                        {
                            var d = c.shift();
                            d()
                        }
            ...
            (), c.title = "browser", c.browser = !0, c.env = {}, c.argv = [],
                    c.binding = function () {
    ...
    6: [function (a, b, c) {
            ...
            function e(a, b, c, d) {
                var e = b.split("\n"), f = Math.max(d - 3, 0),
                        g = Math.min(e.length, d + 3), h = e.slice(f, g).map(function (a, b)
                {
                    var c = b + f + 1;
                    return(c == d ? " >> " : "    ") + c + "| " + a
                }).join("\n");
            ...
            var g = a("./utils"), h = a("path"), i = h.dirname,
                    j = h.extname, k = h.join, l = a("fs"),
                    m = l.readFileSync, n = c.filters = a("./filters"),
                    o = {};
            c.clearCache = function () {
                o = {}
            };
            var p = (c.parse = function (a, b) {
                var b = b || {}, e = b.open || c.open || "<%",
                        g = b.close || c.close || "%>", h = b.filename, i = b.compileDebug !== !1, j = "";
...
{ (function(){ "), j += "\n buf.push('";
                for (var k = 1, l = !1, n = 0, o = a.length; o > n; ++n) {
                    ...
                    if (a.slice(n, e.length + n) == e)
                    {
                        ...
                        var t = a.indexOf(g, n), u = a.substring(n, t), v = n,
                                w = null, x = 0;
                        if ("-" == u[u.length - 1] && (u = u.substring(0, u.length - 2), l = !0),
                                0 == u.trim().indexOf("include"))
                        {
                            ...
                            var z = f(y, h);
                            w = m(z, "utf8"),
                                    w = c.parse(w, {filename: z, _with: !1, open: e, close: g, compileDebug: i}),
                                    j += "' + (function(){" + w + "})() + '", u = ""
                        }
                        for (;
                                ~(x = u.indexOf("\n", x));
                ...
                return j += !1 !== b._with ? "'); })();\n} \nreturn buf.join('');" : "');\nreturn buf.join('');"
                    ...
                    c.compile = function (a, b) {
                        b = b || {};
                        var d = b.escape || g.escape, f = JSON.stringify(a), h = b.compileDebug !== !1,
                                i = b.client, j = b.filename ? JSON.stringify(b.filename) :
                                "undefined";
                        a = h ? ["var __stack = { lineno: 1, input: " + f + ", filename: " + j + " };",
                            e.toString(), "try {", c.parse(a, b), "} catch (err) \n\
{", "  rethrow(err, __stack.input, __stack.filename, __stack.lineno);", "}"]
        ...
        {"./filters": 7, "./utils": 8, fs: 2, path: 3}], 7: [function (a, b, c)
        {
            ...
            }, c.prepend = function (a, b)
            {
                ...
                return Array.isArray(a) ? a.reverse() : String(a).split("")
                        .reverse().join("")
            }, c.get = function (a, b) {
                return a[b]
            }, c.json = function (a) {
            ...
            [function (a, b) {
                    ...
                    function c(a, b) {
                        var c, d, h, i, j;
                        if (this._items = [], this._settings = {bn: g.BN}, e.call(this),
                                f.call(this, a, b),
                    ...
                    var d = a("./product"), e = a("./util/pubsub"),
                            ...
                            i = a("./util/mixin");
                    i(c.prototype, e.prototype), i(c.prototype, f.prototype),
                            c.prototype.add = function (a) {
                                ...
                                for (f = 0, e = i.length; e > f; f++)
                                    if (i[f].isEqual(a))
                                    {
                                        b = i[f], b.set("quantity", b.get("quantity") +
                                                (parseInt(a.quantity, 10) || 1)), j = f, k = !0;
                                        break
                                    }
                                return b ||
                                        (b = new d(a), b.isValid() && (j = this._items.push(b) - 1,
                    ...
                    , c.prototype.discount = function (a)
                    {
                        ...
                        return b || (b = (parseFloat
                                (this.settings("discount_rate_cart")) || 0)
                                * this.subtotal() / 100), a = a || {}
                    ...
                    }, c.prototype.subtotal = function (a)
                    {
                        ...
                        for (b = 0, c = d.length; c > b; b++)
                            e += d[b].total();
                        return a = a || {}, a.currency =
                                this.settings("currency_code"),
                                h(e, a)
                    }, c.prototype.total = function (a)
                    {
                        var b = 0;
                        return b += this.subtotal(), b -= this.discount(),
                                a = a || {},
                                a.currency = this.settings("currency_code"),
                                h(b, a)
                    }, c.prototype.remove = function (a)
                    {
                        ...
                        return 0 === this._items.length && this.destroy(),
                                b && (this.save(),
                                        this.fire("remove", a, b[0])), !!b.length
                    }
                        ...
                        f.prototype.save.call(this,
                            ...
                            c.prototype.destroy = function ()
                            {
                                f.prototype.destroy.call(this),
                                        this._items = [], this._settings = {bn: g.BN},
                                        this.fire("destroy")
                            }, b.exports = c
                },
                {"./constants":
            ...
            [function (a, b) {
                    ...
                    var c = a("./util/mixin"),
                            d = b.exports = {
                                name: "PPMiniCart",
                                parent: "undefined" != typeof document ? document
                                        .body : null,
                                action: "https://www.paypal.com/cgi-bin/webscr", target: "",
                                duration: 30,
                                template:
'<%\n\
...
var creditCart = { format: true, currency: cart.settings("cart_code") };\n\
\n\
var totalFormat = { format: true, showCode: true };\n\
var totalFormatAbdalla ={ format: false, showCode: false };\n\
%>\n\
\n\
\n\
...
<li class="minicart-item">            <div class="minicart-details-name">               \n\
 ...
 { %>                    <li>  \n\
                    ...
                    <input type="hidden" name="item_number_<%= idx %>" value="<%= \n\
items[i].get("item_number") %>" />\n\
\n\
  </li>                    <% } %>                  \n\
  <% if (items[i].discount()) { %>                    <li>     \n\
 ...
 <% for (var options = items[i].options(), j = 0, len2 = options.length; j < len2; j++) { %>   \n\
     ...
     <%= options[j].key %>: <%= options[j].value %>               \n\
        ...
        </div>            <div class="minicart-details-quantity">     \n\
         \n\
...
value="<%= items[i].get("quantity") %>" autocomplete="off"  />  \n\
       \n\
   </div>            <div class="minicart-details-remove">       \n\
         <button type="button" class="minicart-remove" data-minicart-idx="<%= i %>">&times;</button>   \n\
         </div>            <div class="minicart-details-price">         \n\
  ...
  <input type="hidden" name="item_name_<%= idx %>" value="<%= items[i].get("item_name") %>" />    \n\
    ...
    <%= cart.total(totalFormat) %>   \n\
                    ...
                    <input type="hidden" name="items_Length" value="<%= items.length %>">\n\
                    <input type="hidden" name="totalCartWithFormat" value="<%= cart.total(totalFormat) %>">  \n\
            <input type="hidden" name="totalCartWithoutFormat" value="<%= cart.total(totalFormatAbdalla) %>">  \n\
                            <button class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button>\n\
                        </form> \n\
\n\    <button class="minicart-submit" type="submit" data-minicart-alt="\n\
<%= config.strings.buttonAlt %>\n\
\n\
        </div>  ${tempProduct.name}    <!--  \n\ ${testAbdalla} -->\n\
\n\
    <button class="minicart-submit" type="submit" data-minicart-alt="\n\
<%= config.strings.buttonAlt %>\n\
">\n\
...
<% } else { %>     \n\
 ...
 <% for (var key in settings) { %>    \n\
   ...
   <% } %></form>', styles: '@keyframes pop-in {    0% { opacity: 0; transform: scale(0.1); }   \n\
 60% { opacity: 1; transform: scale(1.2); }    \n\
100% { transform: scale(1); }}@-webkit-keyframes pop-in\n\
 {    0% { opacity: 0; -webkit-transform: scale(0.1); }  \n\
  60% { opacity: 1; -webkit-transform: scale(1.2); }    \n\
100% { -webkit-transform: scale(1); }}@-moz-keyframes pop-in {\n\
    0% { opacity: 0; -moz-transform: scale(0.1); }  \n\
  60% { opacity: 1; -moz-transform: scale(1.2); }  \n\
  100% { -moz-transform: scale(1); }}.minicart-showing #PPMiniCart {   \n\
...
#PPMiniCart form {    position: relative;    width: 400px;    max-height: 400px;  \n\
  margin-left: -200px;    padding: 10px 10px 40px;    background: #fbfbfb;    border: 1px solid #d7d7d7; \n\
 border-radius: 4px;    box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.5);    font: 15px/normal arial, helvetica; \n\
   color: #333;}\n\
...
#PPMiniCart ul {    clear: both;  \n\
  float: left;    width: 380px;    margin: 5px 0 20px;    padding: 10px;   \n\
 list-style-type: none;    background: #fff;    border: 1px solid #ccc;  \n\
  border-radius: 4px;    box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.2);}#PPMiniCart \n\
.minicart-empty ul {    display: none;}#PPMiniCart .minicart-closer {   \n\
 float: right;    margin: -12px -10px 0;    padding: 10px;    background: 0;  \n\
  border: 0;    font-size: 18px;    cursor: pointer;    font-weight: bold;}#PPMiniCart \n\
.minicart-item {    clear: left;    padding: 6px 0;    min-height: 25px;}#PPMiniCart \n\
.minicart-item + .minicart-item {    border-top: 1px solid #f2f2f2;}#PPMiniCart \n\
.minicart-item a {    color: #333;    text-decoration: none;}#PPMiniCart \n\
.minicart-details-name {    float: left;    width: 62%;}#PPMiniCart .minicart-details-quantity {  \n\
  float: left;    width: 15%;}#PPMiniCart .minicart-details-remove {    float: left;  \n\
  width: 7%;}#PPMiniCart .minicart-details-price {    float: left;    width: 16%; \n\
   text-align: right;}#PPMiniCart .minicart-attributes {    margin: 0;    padding: 0; \n\
   background: transparent;    border: 0;    border-radius: 0;    box-shadow: none; \n\
   color: #999;    font-size: 12px;    line-height: 22px;}#PPMiniCart .minicart-attributes li {   \n\
 display: inline;}#PPMiniCart .minicart-attributes li:after {    content: ",";}\n\
#PPMiniCart .minicart-attributes li:last-child:after {    content: "";}#PPMiniCart \n\
.minicart-quantity {    width: 30px;    height: 18px;    padding: 2px 4px;   \n\
 border: 1px solid #ccc;    border-radius: 4px;    box-shadow: inset 0 1px 1px \n\
rgba(0, 0, 0, 0.075);    font-size: 13px;    text-align: right;   \n\
 transition: border linear 0.2s, box-shadow linear 0.2s;  \n\
  -webkit-transition: border linear 0.2s, box-shadow linear 0.2s;  \n\
  -moz-transition: border linear 0.2s, box-shadow linear 0.2s;}#PPMiniCart\n\
 .minicart-quantity:hover {    border-color: #0078C1;}#PPMiniCart .minicart-quantity:focus {\n\
  \n\
  \n\
border-color: #0078C1;    outline: 0;   \n\
 box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 3px rgba(0, 120, 193, 0.4);}\n\
#PPMiniCart .minicart-remove {    width: 18px;    height: 19px;    margin: 2px 0 0; \n\
   padding: 0;    background: #b7b7b7;    border: 1px solid #a3a3a3;    border-radius: 3px; \n\
   color: #fff;    font-size: 13px;    opacity: 0.70;    cursor: pointer;}#PPMiniCart \n\
.minicart-remove:hover {    opacity: 1;}#PPMiniCart .minicart-footer {  \n\
  clear: left;}#PPMiniCart .minicart-subtotal {    position: absolute; \n\
   bottom: 17px;    padding-left: 6px;    left: 10px;    font-size: 16px; \n\
   font-weight: bold;}#PPMiniCart .minicart-submit {    position: absolute;  \n\
  bottom: 10px;    right: 10px;    min-width: 153px;    height: 33px;   \n\
 margin-right: 6px;    padding: 0 9px;    border: 1px solid #ffc727;   \n\
 border-radius: 5px;    color: #000;    text-shadow: 1px 1px 1px #fff6e9;   \n\
 cursor: pointer;    background: #ffaa00;  \n\
  background:\n\
 url(data:image/svg+xml;base64,);    background: -moz-linear-gradient(top, #fff6e9 0%, #ffaa00 100%);    background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#fff6e9), color-stop(100%,#ffaa00));  \n\
  ...
  background: linear-gradient(to bottom, #fff6e9 0%,#ffaa00 100%);}#PPMiniCart\n\
 .minicart-submit img {    vertical-align: middle;    padding: 4px 0 0 2px;}'
            ...
            "use strict";
            b.exports = {COMMANDS:
                        {_cart: !0, _xclick: !0, _donations: !0}, SETTINGS:
                ...
                KEYUP_TIMEOUT: 500, SHOWING_CLASS: "minicart-showing", REMOVE_CLASS: "minicart-remove",
                CLOSER_CLASS: "minicart-closer", QUANTITY_CLASS: "minicart-quantity", ITEM_CLASS: "minicart-item",
                ITEM_CHANGED_CLASS: "minicart-item-changed", SUBMIT_CLASS: "minicart-submit",
            ...
            i.render = function (a)
            {
                d = i.config = h.load(a), c = i.cart = new f(d.name, d.duration), e = i.view = new g({config: d, cart: c})
                        , c.on("add", e.addItem, e), c.on("change", e.changeItem, e), c.on("remove", e.removeItem, e),
        ...
        }, {"./cart": 9, "./config": 10, "./view": 22}], 13: [function (a, b)
        {
            "use strict";
            function c(a) {
                a.quantity = g.quantity(a.quantity), a.amount = g.amount(a.amount),
                        a.href = g.href(a.href), this._data = a, this._options = null, this._discount = null, this._amount = null,
                        this._total = null, e.call(this)
            }
            ...
            f(c.prototype, e.prototype), c.prototype.get = function (a) {
                return a ? this._data[a] : this._data
                    ...
                    c.prototype.set = function (a, b) {
                        var c = g[a];
                        this._data[a] = c ? c(b) : b, this._options = null, this._discount = null,
                                this._amount = null, this._total = null, this.fire("change", a)
            ...
            b.exports.add = function (a, b) {
                ...
                var c;
                return a ? void(b && (c = document.createElement("style"), c.type = "text/css", c
                        .styleSheet ? c.styleSheet.cssText = b : c.appendChild(document.createTextNode(b)), a.appendChild(c))) : !1
            }
        }, {}], 15: [function (a, b) {
            "use strict";
