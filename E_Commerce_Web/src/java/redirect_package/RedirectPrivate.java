 ...
 * @author Hesham
 */
@WebServlet(name = "RedirectPrivate", urlPatterns = {"/RedirectPrivate"})
public class RedirectPrivate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/Error-Page/privatePage.jsp").forward(request, response);
                    } else {
